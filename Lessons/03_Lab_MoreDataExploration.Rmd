...
high_temps <- c(58, 41, 43, 46, 36, 42, 49, 52, 56, 67, 60, 49, 50, 48, 50)
low_temps <- c(31, 20, 25, 28, 19, 23, 25, 29, 43, 49, 36, 32, 30, 31, 37)
...
changetocelsius <- function(x) {
  (x - 32) * .5556
}

high_celsius <- changetocelsius(high_temps)
low_celsius <- changetocelsius(low_temps)
...
temp_df <- data.frame(high_celsius,low_celsius, low_temps, high_temps)
names(temp_df) <- c("High C", "Low C", "Low F", "High F")
View(temp_df)
```
