...
> ANSWER: Find in Metadata folder; 
...
#needs two main inputs- column name of dataset and what type of format that you want (see above for the two options)
...
# paste0 glues strings together e.g. gluing 19 and 20 to the dates
